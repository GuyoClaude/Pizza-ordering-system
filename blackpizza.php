   ...
   $mysqli = new mysqli('localhost', 'root', 'localhost8080', 'pizza_system') or die(mysqli_error(mysqli));
    ...
    ?>    <br><br>
          <div class="text-center" id="top-text">
           <h3 class="text-center">BlackBerry Pizza </h3>
           <h3 class="text-center" style="color:red">Price Ksh 1200</h3>
                ...
                <div class="container">
                    ...
                    while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="blackpizza.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Remove Order</a>
                                </td>
                        ...
                        <form action="process.php" method="POST">
                           <input type="hidden" name="id" value="<?php echo $id ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="price" class="form-control" value="Ksh 1200" placeholder="Price" required >
                            </div>
                            
                            <div class="form-group">
                                <label for="location">Cake Type</label>
                                <input type="text" name="type" class="form-control" value="BlackBerr Pizza" placeholder="Cake Type" required >
                            </div>
