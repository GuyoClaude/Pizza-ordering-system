   ...
   $mysqli = new mysqli('localhost', 'root', 'localhost8080', 'pizza_system') or die(mysqli_error(mysqli));
    ...
    ?>    <br><br>
          <div class="text-center" id="top-text">
           ...
           <h3 class="text-center" style="color:red">Price Ksh 1250</h3>
                ...
                <div class="container">
                    ...
                    while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="Sicilian.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Remove Order</a>
                                </td>
                        ...
                        <form action="process.php" method="POST">
                           <input type="hidden" name="id" value="<?php echo $id ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="price" class="form-control" value="Ksh 1250" placeholder="Price" required disabled>
                            </div>
                            
                            <div class="form-group">
                                <label for="location">Cake Type</label>
                                <input type="text" name="type" class="form-control" value="Sicilian Pizza" placeholder="Cake Type" required disabled>
                            </div>
